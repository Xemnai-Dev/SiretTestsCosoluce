...
namespace SirenAndSiretTests
{
    ...
    public class SiretTest
    {
        ...
        {
            Siret siret = new Siret("800403222","00014"); // invalid, first constructor
            Assert.IsFalse(siret.IsValid);
        }
        [TestMethod]
        public void TestValidSiretIsValidFirstConstructor()
        {
            Siret siret = new Siret("800403222","00015"); // valid, first constructor
        ...
        {
            Siret siret = new Siret(new Siren("800403222"), "00014"); // invalid, second constructor
            Assert.IsFalse(siret.IsValid);
        }
        [TestMethod]
        public void TestValidSiretIsValidSecondConstructor()
        {
            Siret siret = new Siret(new Siren("800403222"), "00015"); // valid, second constructor
            Assert.IsTrue(siret.IsValid);
        }
        [TestMethod]
        ...
        {
            Siret siret = new Siret("80040322200014"); // invalid, third constructor
            Assert.IsFalse(siret.IsValid);
        }
        [TestMethod]
        public void TestValidSiretIsValidThirdConstructor()
        {
            Siret siret = new Siret("80040322200015"); // valid, third constructor
            Assert.IsTrue(siret.IsValid);
        }
        [TestMethod]
